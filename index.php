<?php $color = isset($_GET['theme']) ? $_GET['theme'] : 'stylish-yellow'; ?>

<!doctype html>
<html>
<head>
    <title>jQuery Tagit Demo Page (PHP)</title>
    <link href="demo/css/jquery-ui-base-1.8.20.css" rel="stylesheet" type="text/css"/>
...
<div class="box"><strong>Theme: </strong>
    ...
    <a href="?theme=awesome-blue#demos">Awesome Bluey</a> |
</div>
